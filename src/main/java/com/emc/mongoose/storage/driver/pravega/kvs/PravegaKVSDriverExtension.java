...
public final class PravegaKVSDriverExtension<I extends DataItem, O extends DataOperation<I>, T extends PravegaKVSDriver<I, O>>
	...
	public T create(
		...
		return (T) new PravegaKVSDriver<I, O>(stepId, dataInput, storageConfig, verifyFlag, batchSize);
	}
}
